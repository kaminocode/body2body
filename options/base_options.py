...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', required=False,default="./temp/", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--name', type=str, default='dance_mimic', help='name of the experiment. It decides where to store samples and models')
